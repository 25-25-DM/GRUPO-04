...
fun AppNavigation() {
    ...
    val usuarios = remember {
        mutableStateListOf(
            Usuario("user", "apellido", hashSHA256("123456"))
        )
    }
    ...
    var apellidoIngresado by remember { mutableStateOf("") } // Nuevo: para almacenar el apellido ingresado en login
    ...
    NavHost(navController = navController, startDestination = "splash") {
        ...
        composable("login") {
            LoginScreen(
                ...
                onLoginSuccess = { apellidoLogin ->
                    apellidoIngresado = apellidoLogin // Guardar el apellido ingresado
        ...
        composable("usuariosCifrados") {
            UsuariosCifradosScreen(
                usuarios = usuarios,
                apellidoIngresado = apellidoIngresado, // Pasa el apellido del login
